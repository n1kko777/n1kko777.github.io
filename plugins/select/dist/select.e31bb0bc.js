...
var getTemplate = function getTemplate() {
  ...
  return "\n<div class=\"select__backdrop\" data-type=\"backdrop\"></div>\n  <div class=\"select__input\" data-type=\"input\">\n      <span data-type=\"value\">".concat(placeholder, "</span>\n      <i class=\"fa fa-chevron-down\" data-type=\"arrow\"></i>\n  </div>\n  <div class=\"select__dropdown\">\n      <ul class=\"select__list\">\n          ").concat(data.map(function (el) {
    return "<li class=\"select__item".concat(selectedId === el.id ? " selected" : "", "\" data-type=\"item\" data-id=\"").concat(el.id, "\">").concat(el.value, "</li>");
  }).join(""), "\n      </ul>\n  </div>\n");
};
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    value: function select(id) {
      ...
      this.$el.querySelector(".selected") !== null && this.$el.querySelector(".selected").classList.remove("selected");
...
var _render2 = function _render2() {
  ...
  this.$el.innerHTML = getTemplate(data, this.selectedId !== undefined ? data !== undefined && data.find(function (el) {
    return el.id === _this2.selectedId;
  }) !== undefined ? data.find(function (el) {
    return el.id === _this2.selectedId;
  }).value : "" : placeholder, this.selectedId);
};
...
},{"./bundle-url":"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"select/styles.scss":[function(require,module,exports) {
...
window.s = select;
},{"./select/select":"select/select.js","./select/styles.scss":"select/styles.scss"}],"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
